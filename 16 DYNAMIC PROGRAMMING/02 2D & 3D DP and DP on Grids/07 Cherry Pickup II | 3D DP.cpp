...
============================================================================================================
  CATEGORY: 3D DP
            ...
            *-- both should be calculated simultaneously because (j1==j2) that cell should be considered only once
...
int f(int i, int j1, int j2, int n, int m,
    ...
    int maxi = 0;
    //* iterating over all possible combinations of movements of Alice and Bob
    for (int dj1=-1; dj1 <= 1; dj1++) {
        for (int dj2=-1; dj2 <= 1; dj2++) {
            ...
            if (curr != -1e9)
                if (j1 == j2) //* Alice and Bob are currently on the same cell, so should be considered only once
