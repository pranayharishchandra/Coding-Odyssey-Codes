// * https://github.com/pranayharishchandra/DAILY-DSA/blob/main/DSA/GRAPHS/STRIVER/34.DijkstraAlgorithmSET.cpp#L50
...
so we will store - {node, distance}
so for every node we will be having only 1 distance in our set
*/
 ...
 * we can't go to those elements so their dis will remain INT_MAX
